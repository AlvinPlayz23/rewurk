...
type Styles struct {
	...
	Header struct {
		...
		Keystroke         lipgloss.Style // Style for keystroke hints.
	...
	BackgroundPanel color.Color // Panel background (header, editor, status bars)
	BackgroundChat  color.Color // Chat area background
	FgBright        color.Color // Bright foreground (--fg-bright in mockup)

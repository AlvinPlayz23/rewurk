...
type quickStyleOpts struct {
	...
	// Panel and chat area backgrounds.
	bgPanel color.Color
	bgChat  color.Color
...
func quickStyle(o quickStyleOpts) Styles {
	...
	s.Background = o.bgChat
	s.BackgroundPanel = o.bgPanel
	s.BackgroundChat = o.bgChat
	s.FgBright = o.fgBright
	...
	s.Messages.AssistantBlurred = lipgloss.NewStyle().
		Foreground(o.accent).
		SetString("  ")
	s.Messages.AssistantFocused = lipgloss.NewStyle().
		Foreground(o.accent).
		Bold(true).
		SetString("  ")

...
const assistantStatusPhraseFrameCount = 40

var assistantStatusPhrases = []string{
	"Thinking...",
	"Streaming...",
	"Ruminating...",
	"Hold on, let me think more...",
	"Working through it...",
...
func (a *AssistantMessageItem) renderSpinning() string {
	phrase := assistantStatusPhrases[(a.statusStep/assistantStatusPhraseFrameCount)%len(assistantStatusPhrases)]
	if a.message.IsSummaryMessage {
		phrase = "Summarizing..."
	}
	return lipgloss.NewStyle().Foreground(a.sty.WorkingLabelColor).Render(phrase)
}
